    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="assets-admin/images/logo.svg" class="mr-2"
                        alt="logo" /></a>
                    ...
                    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img src="assets-admin/images/faces/face1.jpg" alt="image"><span
                            ...
                            <li class="list">
                                <div class="profile"><img src="assets-admin/images/faces/face2.jpg" alt="image"><span
                            ...
                            <li class="list">
                                <div class="profile"><img src="assets-admin/images/faces/face3.jpg" alt="image"><span
                                        class="online"></span></div>
                                <div class="info">
                                    <p>Daniel Russell</p>
                                    <p>Available</p>
                            ...
                            <li class="list">
                                <div class="profile"><img src="assets-admin/images/faces/face4.jpg" alt="image"><span
                                        class="offline"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="assets-admin/images/faces/face5.jpg" alt="image"><span
                                        class="online"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="assets-admin/images/faces/face6.jpg" alt="image"><span
                                        class="online"></span></div>
                                <div class="info">
                                    <p>Sarah Graves</p>
                                    <p>Available</p>

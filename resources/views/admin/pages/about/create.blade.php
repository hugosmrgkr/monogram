            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('about.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="weekday_hours" placeholder="Contoh: 11.00 - 20.00">
                    </div>
                    <div class="form-group">
                        <label for="weekend_hours">Jam Operasional (Minggu)</label>
                        <input type="text" class="form-control" name="weekend_hours" placeholder="Contoh: 15.00 - 21.00">
                    </div>
